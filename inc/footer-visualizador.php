      ...
      <div class="Grid">
        <div class="Grid-item u-md-size1of3">
          <div class="Footer-info u-md-pr3">
            <h3 class="Footer-title">Visualizador de Datos Abiertos y Estadísticas</h3>
          ...
          <div class="Grid">
            <div class="Grid-item u-md-size1of3">
              <div class="Footer-list u-md-pl3">
                <h3>Visualizador</h3>
                <ul class="u-bullet">
                  <li><a href="#">Elemento de menú</a></li>
                  <li><a href="#">Enlace a otra sección</a></li>
                  <li><a href="#">Enlace úlitma sección</a></li>
                </ul>
              </div>
            </div>
            <div class="Grid-item u-md-size1of3">
              <div class="Footer-list">
                <h3>Relacionados</h3>
                <ul class="u-bullet">
                  <li><a href="#">Catálogo de Datos Abiertos</a></li>
          ...
          <div class="Footer-logos">
              ...
              <a href="https://www.gub.uy/agencia-gobierno-electronico-sociedad-informacion-conocimiento/">
                <img src="./assets/logo-agesic-blanco.png" alt="Agesic" style="margin-top: .25rem;">
						...
						-->
						<div class="Footer-logo u-ml3">
							<a href="#" class="Logo">
								<img class="Logo-image" src="./assets/escudo-blanco.svg" alt="">
								<div class="Logo-text">
									<div class="Logo-title">
										<span class="Logo-role">Organismo</span>
										<span>Responsable del</span>
